...
IF %pypy%==n > %~dp0venv\Lib\site-packages\bossfight.pth ECHO %~dp0bossfight.client\
IF %pypy%==n >> %~dp0venv\Lib\site-packages\bossfight.pth ECHO %~dp0bossfight.core\
IF %pypy%==n >> %~dp0venv\Lib\site-packages\bossfight.pth ECHO %~dp0bossfight.server\
IF %pypy%==y > %~dp0pypyvenv\site-packages\bossfight.pth ECHO %~dp0bossfight.client\
IF %pypy%==y >> %~dp0pypyvenv\site-packages\bossfight.pth ECHO %~dp0bossfight.core\
IF %pypy%==y >> %~dp0pypyvenv\site-packages\bossfight.pth ECHO %~dp0bossfight.server\
ECHO ##################################
